...
export const SLOTS: Slot[] = [
  ...
  { id: "F6", number: 6, label: "Blindside Flanker", accepts: ["flanker"], x: 22, y: 33 },
  { id: "F7", number: 7, label: "Openside Flanker", accepts: ["flanker"], x: 78, y: 33 },
  { id: "N8", number: 8, label: "Number 8", accepts: ["number8"], x: 50, y: 35 },
